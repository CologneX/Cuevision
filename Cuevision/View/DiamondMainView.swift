...
//                print(results.debugDescription)
    ...
    func calculateAimDiamond(cueBall: CGPoint, targetBall: CGPoint) -> CGPoint {
        ...
        let resultPointTranslation = analysisDiamondVM.findPointTranslation(from: CGPoint(x: aimX, y: aimY), widthPoolBoundary: widthPoolBoundary2, heightPoolBoundary: heightPoolBoundary2, sizeBall: 25)
